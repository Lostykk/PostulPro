...
- **Ya no queda ningún bloqueante técnico para el cutover.** Lo que queda son decisiones de producto no urgentes (emails de marca propios de la app vía `RESEND_API_KEY`, todavía sin configurar) y la logística de programar la ventana de corte en sí.
