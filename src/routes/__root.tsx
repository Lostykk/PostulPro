...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PostulPro — Generá ingresos reales con IA" },
      {
        name: "description",
        content:
          "La plataforma todo-en-uno que convierte tu conocimiento y la IA en productos digitales que venden solos.",
      },
      { name: "author", content: "PostulPro" },
      { name: "theme-color", content: "#07070E" },
      { property: "og:title", content: "PostulPro — Generá ingresos reales con IA" },
      {
