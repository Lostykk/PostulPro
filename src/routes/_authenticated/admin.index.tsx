...
import { Users, DollarSign, TrendingUp, Zap, ShoppingBag, Search, Gift } from "lucide-react";
...
// The general admin dashboard — index route under the /admin layout (see
// admin.tsx, which owns the auth gate and renders <Outlet /> for this and
// any sibling admin subpage, e.g. admin.promotional-credits.tsx). Auth is
// already enforced by the parent layout by the time this ever mounts.
